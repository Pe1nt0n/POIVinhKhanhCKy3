    ...
    <div className="space-y-6 animate-fade-in">
      <div className="bg-gradient-to-r from-[#e65100] to-orange-400 rounded-3xl p-8 text-white shadow-xl">
        ...
        <p className="text-orange-100 max-w-2xl text-lg">
          Chào mừng bạn đến với Cổng Quản lý Đối tác Ẩm thực Quận 4. Tại đây, bạn có thể đăng ký quán mới, nhờ AI viết bài quảng cáo, và theo dõi lượng du khách tương tác.
        </p>
      </div>
